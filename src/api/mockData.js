export const mockProjects = [
  ...
  { source: 'novel_miniapp', appId: 'pkg-novel-yunyou-we', appName: '云游阅读', platform: 'wechat', category: 'novel', version: '9.9.9', entryUrl: 'http://172.17.7.183:8080/miniapp/novel/home', updateTime: '2026-05-29T10:05:00+08:00' },
  ...
  { source: 'comic_miniapp', appId: 'pkg-comic-sub-wechat', appName: '漫剧马甲包', platform: 'wechat', category: 'comic', version: '2.1.0', entryUrl: 'http://172.17.7.183:5177/apps', updateTime: '2026-05-29T10:03:00+08:00' },
  ...
  { source: 'video_miniapp', appId: 'pkg-video-sub-wechat', appName: '影视分销', platform: 'wechat', category: 'video', version: '1.5.2', entryUrl: 'http://172.17.7.183:8080/miniapp/autocreate/video/apps', updateTime: '2026-05-29T10:01:00+08:00' },
  ...
  { source: 'h5', appId: 'pkg-h5-novel-config', appName: 'H5小说配置', platform: 'web', category: 'h5', version: '1.2.0', entryUrl: 'http://172.17.3.118/h5novelwebconfig/', updateTime: '2026-05-29T09:59:00+08:00' },
  { source: 'h5', appId: 'pkg-h5-video-main', appName: 'H5影视主站', platform: 'web', category: 'h5_video', version: '1.1.4', entryUrl: 'http://172.17.3.118/h5novelwebconfig/', updateTime: '2026-05-29T09:58:00+08:00' },
  { source: 'h5', appId: 'pkg-h5-distribution', appName: 'H5分销页', platform: 'web', category: 'h5_distribution', version: '1.0.6', entryUrl: 'http://172.17.3.118/h5novelwebconfig/', updateTime: '2026-05-29T09:57:00+08:00' },
  { source: 'h5', appId: 'pkg-h5-growth', appName: 'H5拉新活动', platform: 'web', category: 'h5_growth', version: '1.0.1', entryUrl: 'http://172.17.3.118/h5novelwebconfig/', updateTime: '2026-05-29T09:56:00+08:00' }
]
