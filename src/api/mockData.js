export const mockProjects = [
  ...
  { source: 'manju_miniapp', appId: 'pkg-comic-main-douyin', appName: '漫剧主站', platform: 'douyin', category: 'manju', version: '3.0.2', entryUrl: 'http://172.17.7.183:5177/apps', updateTime: '2026-05-29T10:04:00+08:00' },
  { source: 'manju_miniapp', appId: 'pkg-comic-sub-wechat', appName: '漫剧马甲包', platform: 'weixin', category: 'manju', version: '2.1.0', entryUrl: 'http://172.17.7.183:5177/apps', updateTime: '2026-05-29T10:03:00+08:00' },
  { source: 'yingshi_miniapp', appId: 'pkg-video-main-douyin', appName: '影视主站', platform: 'douyin', category: 'yingshi', version: '2.3.1', entryUrl: 'http://172.17.7.183:8080/miniapp/autocreate/video/apps', updateTime: '2026-05-29T10:02:00+08:00' },
  { source: 'yingshi_miniapp', appId: 'pkg-video-sub-wechat', appName: '影视分销', platform: 'weixin', category: 'yingshi', version: '1.5.2', entryUrl: 'http://172.17.7.183:8080/miniapp/autocreate/video/apps', updateTime: '2026-05-29T10:01:00+08:00' },
  { source: 'playlet_miniapp', appId: 'pkg-drama-a-kuaishou', appName: '短剧A版', platform: 'kuaishou', category: 'playlet', version: '1.0.8', entryUrl: 'http://172.17.7.183:5177/apps', updateTime: '2026-05-29T10:00:00+08:00' },
  ...
  { source: 'h5', appId: 'pkg-h5-distribution', appName: 'H5分销页', platform: 'web', category: 'h5_fenxiao', version: '1.0.6', entryUrl: 'http://172.17.3.118/h5novelwebconfig/', updateTime: '2026-05-29T09:57:00+08:00' },
  { source: 'h5', appId: 'pkg-h5-growth', appName: 'H5拉新活动', platform: 'web', category: 'h5_laxin', version: '1.0.1', entryUrl: 'http://172.17.3.118/h5novelwebconfig/', updateTime: '2026-05-29T09:56:00+08:00' }
]
